...
directory = './player_data_redzone'

'''
Add headers for each position
Add seas and stat_type to headers
'''
        ...
        for pos_idx, pos in enumerate(default_pos):
            ...
            for week in default_weeks:
                ...
                for stat_idx, stat_type in enumerate(default_stat_types):
                    ...
                    print(ew, 'ew')
                    print(p, 'p')
                    # player_data_url = 'https://fantasydata.com/nfl-stats/nfl-fantasy-football-stats.aspx?fs=2&stype=0&sn=0&scope=2&w=0&ew=0&s=&t=0&p=0&st=FantasyPointsFanDuel&d=1&ls=&live=false&pid=false&minsnaps=4'
